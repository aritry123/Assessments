                    ...
                    <div className="card k1" style={{margin: '5px', backgroundColor: '#dddddd', boxShadow: '-4px 2px 2px 2px #dcdde1'}}>
                        <div className="card-body" style={{backgroundColor: `${item.bg}`}}>
                            ...
                            <p className="card-text"><b>Ticket ID: </b>{item.id}</p>
                            {
                                flag===item.id ? 
                                <>
                                <input type="text" placeholder="Add Summary" style={{marginRight: '5px',borderRadius: '5px',border: 'solid'}} onChange={(e)=>handleInput(e)}></input>
                                <button style={{borderRadius: '5px',width: '50px',backgroundColor: 'pink',border: 'solid'}} onClick={(e)=>addSummary(input,item.id)}>Close</button>
                                </>
